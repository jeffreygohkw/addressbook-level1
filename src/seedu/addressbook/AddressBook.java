...
public class AddressBook {
     ...
     */
    private static String getMessageForZeroPersonsDisplayedSummary(ArrayList<HashMap<PersonProperty, String>> personsDisplayed) {
     ...
     */
    private static void quickSortByName(ArrayList<HashMap<PersonProperty, String>> personArray, int min, int max)
     ...
     * @param max The maximum index of the ArrayList we consider to execute Quick Sort on
     */
    private static void quickSortByPhone(ArrayList<HashMap<PersonProperty, String>> personArray, int min, int max)
        throws IndexOutOfBoundsException {
        if (personArray.size() == 0) {
            return;
        }
     ...
     * @param max The maximum index of the ArrayList we consider to execute Quick Sort on
     */
    private static void quickSortByEmail(ArrayList<HashMap<PersonProperty, String>> personArray, int min, int max)
        throws IndexOutOfBoundsException {
        if (personArray.size() == 0) {
            return;
        }
     ...
     */
    private static void swapPersonInArray(ArrayList<HashMap<PersonProperty, String>> personArray, int low, int high)
        throws IndexOutOfBoundsException {
        if (personArray.size() == 0) {
            return;
        }
        ...
        HashMap<PersonProperty, String> temp = personArray.get(low);
